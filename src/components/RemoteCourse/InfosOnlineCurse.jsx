...
const type='info'
  ...
  return (
    <div className="bg-white mt-4 rounded-xl max-h-[634px] w-full p-[25px] overflow-y-scroll scrollbar-hide">
 ...
 return (  <div key={index} className="w-18rem border p-5 mt-3 max-w-sm ">
...
{picture.length !== 0 && (
 ...
 <div className="card-body">
   ...
   <button className="bg-blue-300 rounded-md p-1 m-3 bold text-white hover:text-red-600 hover:bg-blue-800">Sehe mehr Infos</button>
