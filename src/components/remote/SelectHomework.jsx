...
function SelectHomework() {
  const { getHomeworksByType, setHomeworkId } = useContext(Context);
  ...
  const [onlineDatas, setOnlineDatas] = useState([]);
  ...
  useEffect(() => {
    getHomeworksByType("online")
      .then((res) => {
        if (res.message === "success") {
          setOnlineDatas(res.data);         
        }
      })
      .catch((err) => {
        console.log(err);
